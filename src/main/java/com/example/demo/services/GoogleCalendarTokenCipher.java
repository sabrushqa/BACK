...
@Component
public class GoogleCalendarTokenCipher {
    ...
    public GoogleCalendarTokenCipher(
        @Value("${app.google-calendar.token-encryption-key:}") String encodedKey
    ) {
    ...
    public String encrypt(String clearText) {
        if (!isConfigured()) {
            throw new IllegalStateException("La clé de chiffrement Google Calendar n'est pas configurée.");
        }
        if (!StringUtils.hasText(clearText)) {
            throw new IllegalArgumentException("Le jeton Google Calendar est vide.");
        }
        ...
        try {
            ...
            throw new IllegalStateException("Impossible de chiffrer le jeton Google Calendar.", exception);
        }
    }
    ...
    public String decrypt(String encryptedText) {
        ...
        if (!StringUtils.hasText(encryptedText) || !encryptedText.startsWith(VERSION_PREFIX)) {
            throw new IllegalArgumentException("Le jeton Google Calendar chiffré est invalide.");
        }
        ...
        try {
            ...
            throw new IllegalStateException("Impossible de déchiffrer le jeton Google Calendar.", exception);
        }
    }
